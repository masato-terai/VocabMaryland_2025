...
title-slide-attributes:
  data-background-image: material/maron.png
...
- Huettig et al. (2020)
  ...
  - eye-tracking study
    ...
    - Experiment 3: *Pictures were presented for 3s, then disappeared with the onset of the audio.
...
RT (reaction time) of the Stroop task from Terai (2023) and Terai (2024)
  ...
  - Word level (Japanese participants in both tasks)
    ...
    - Only the language used in the first task was analyzed
